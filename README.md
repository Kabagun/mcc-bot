...
The checked-in catalog contains fifteen cards and 2,819 explicit MCC offers. It
...
`maximum_reward` stores either a finite `currency` or `points` cap, or an
explicit unlimited cap such as
...
comma decimals and never prints raw catalog notes.
